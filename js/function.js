...
//aboutme resume 영역
//온라인이력서 모달창
const $btnIam = $('#aboutme >.container> .profile > div > ol > li:last-of-type > a')
...
$(function () {
	//1. 페이드슬라이드 (리뉴얼디자인부분)
	const $slides = $('#portfolio > article.slides1 > .slides-container > figure ')
	const $indicator = $('#portfolio > article.slides1 > .slides-pagination > li > a')
	const $btnPrev = $('#portfolio > article.slides1 .slides-prev')
	const $btnNext = $('#portfolio > article.slides1 .slides-next')
	...
	//모달(라이트박스)
	const $btnProc = $('#portfolio > article.slides1 a.proc')
	const $shadow = $('#portfolio > article.slides1 .shadow')
...
$(function () {
	//2. 페이드슬라이드 (리액트부분)
	const $slides = $('#portfolio > article.slides2 > .slides-container > figure ')
	const $indicator = $('#portfolio > article.slides2 > .slides-pagination > li > a')
	const $btnPrev = $('#portfolio > article.slides2 .slides-prev')
	const $btnNext = $('#portfolio > article.slides2 .slides-next')
	...
	//모달(라이트박스)
	const $btnProc = $('#portfolio > article.slides2 a.proc')
	const $shadow = $('#portfolio > article.slides2 .shadow')
	const $lightbox = $shadow.children('.lightbox')
	const $btnClse = $shadow.children('.clse')
...
$(function () {
	...
	//모달(라이트박스)
	const $btnProc = $('#portfolio > article.slides3 a.proc')
	const $shadow = $('#portfolio > article.slides3 .shadow')
	const $lightbox = $shadow.children('.lightbox')
	const $btnClse = $shadow.children('.clse')
...
$(function () {
	...
	//모달(라이트박스)
	const $btnProc = $('#portfolio > article.slides4 a.proc')
	const $shadow = $('#portfolio > article.slides4 .shadow')
	const $lightbox = $shadow.children('.lightbox')
	const $btnClse = $shadow.children('.clse')
